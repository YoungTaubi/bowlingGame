...
export class ThirdPersonControl_3 {
    scene: any;
    engine: any;
    camera!: FreeCamera;
    character!: any;
    ...
    constructor(private canvas: HTMLCanvasElement) {
        ...
        var light2 = new BABYLON.DirectionalLight("light2", new BABYLON.Vector3(-1, -1, -1), this.scene);
        light2.position = new BABYLON.Vector3(0, 128, 0);
        light2.intensity = 0.7;

        let groundMaterial = createGroundMaterial(this.scene);
        var ground = createGround(this.scene, groundMaterial);
        loadPlayer(this.scene, this.engine, this.canvas);
...
LoadPlayer(this.scene, this.engine, canvas) {
    BABYLON.SceneLoader.ImportMesh("", "player/", "Vincent-frontFacing.babylon", this.scene, function (meshes, particleSystems, skeletons) {
        var player = meshes[0];
...
// function createGround(this.scene, groundMaterial) {
...
// function createGroundMaterial(this.scene) {
//     let groundMaterial = new BABYLON.StandardMaterial("groundMat", this.scene);
//     groundMaterial.diffuseTexture = new BABYLON.Texture("ground/ground.jpg", this.scene);
//     groundMaterial.diffuseTexture.uScale = 4.0;
//     groundMaterial.diffuseTexture.vScale = 4.0;

//     groundMaterial.bumpTexture = new BABYLON.Texture("ground/ground-normal.png", this.scene);
