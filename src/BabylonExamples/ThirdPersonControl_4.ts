...
export class ThirdPersonControl_4 {
    scene: Scene;
    engine: Engine;
    camera!: FreeCamera
    ...
    async CreateCharacter(): Promise<void> {
        ...
        let characterYPos = this.camera.position.y
        ...
        const charaterPhysics = () => {
            ...
            //     }
            // })
        characterBoundingBox.position.y = characterYPos
            characterBoundingBox.rotation = new Vector3(0, this.camera.rotation._y * 1.5, 0)
